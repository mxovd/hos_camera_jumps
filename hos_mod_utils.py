#!/usr/bin/env python3
"""Build and package the Camera Jumps mod for distribution."""
...
MOD_NAME = "Camera Jumps"
PACKAGE_PREFIX = "camera-jumps"
PROJECT_FILENAME = "CameraJumps.csproj"
OUTPUT_DLL_NAME = "CameraJumps.dll"
MOD_FOLDER_NAME = "Camera Jumps"
